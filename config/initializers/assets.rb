...
Rails.application.config.assets.precompile += %w(employer/plugins.js employer/plugins.css employer/app.js employers/search.js)
...
Rails.application.config.assets.precompile += %w(employers/interview_type.js)
